...
{
    include_once __DIR__ . '/vendor/dg/adminer-custom/plugins/plugin.php';

    foreach (glob(__DIR__ . '/plugins/*.php') as $filename) {
        include_once $filename;
    }

    foreach (glob(__DIR__ . '/vendor/dg/adminer-custom/plugins/*.php') as $filename) {
        include_once $filename;
    }
...
include __DIR__ . '/vendor/dg/adminer-custom/adminer.php';